...
(b)Se o nome está na lista ['Musial', 'Aaraon', 'Williams', 'Gehrig', 'Ruth'], exiba 
...
golpes = int(input('Informe o números de golpes recebidos: '))
defesas = int(input('Informe o valor das defesas: '))
